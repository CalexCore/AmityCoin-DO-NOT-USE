...
const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX_V4              = 10000; // This will need changing if we decide different
...
const uint32_t UPGRADE_HEIGHT_V6							 = 10000; // Alter CN-Soft Shell Varaint 1 < Again, needs changing
