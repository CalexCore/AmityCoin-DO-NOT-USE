...
const uint64_t MINIMUM_MIXIN_V5                              = 3;
const uint64_t MAXIMUM_MIXIN_V5                              = 3;
...
const uint64_t DEFAULT_MIXIN_V5                              = 3;
...
const uint64_t TRANSACTION_SIGNATURE_COUNT_VALIDATION_HEIGHT = 100000;
...
const std::string DEFAULT_DONATE_ADDRESS                     = "amitQLHwwcaU5bDjqkZrQ26KHeVdk2mgsC8j8mnBJbpJfi6jMNxUqB42V2ZCn6EJ4z9wK5nVvNBwMVBFubZce3BXAYAJx2YEon";
